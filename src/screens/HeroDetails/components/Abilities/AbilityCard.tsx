...
export const AbilityCard = React.memo(
  ({
    ...
    const calculateGradientHeight = useCallback(() => {
      ...
      const totalHeight =
        32 + SPACING.SM + estimatedLines * 20 + SPACING.MD * 2;
    ...
    return (
      <View style={styles.abilityCardEnhanced} onTouchEnd={handleCardPress}>
        <OptimizedVideo
          ref={videoRef}
        ...
        {isOverlayVisible && (
          <>
            <View
              style={[styles.abilityGradientBottom, { height: gradientHeight }]}
            />
            <View style={styles.abilityOverlay} onLayout={handleOverlayLayout}>
